...
<p><a href="<{$xoops_url}>/userinfo.php?uid=<{$shiori.uid}>"><{"Profile"|shiori_msg}></a>&nbsp;
    <span style="font-weight:bold;">&raquo;&raquo;</span>&nbsp;<{"Bookmarks"|shiori_msg}></p>
...
<form name="bookmark" action="index.php?action=delete" method="post">
    <{securityToken}><{*//mb*}>
    <table border="0" class="outer" cellspacing="1" cellpadding="4" summary="<{"Bookmarks"|shiori_msg}>"
           style="width:100%;">

        <tr>
            <th><input id="allbox" onclick="xoopsCheckGroup('bookmark', 'allbox', 'del_bok[]');" type="checkbox"
                       value="<{"check all"|shiori_msg}>" name="allbox"></th>
            <th>&nbsp;</th>
        ...
        <tr>
            <{if ($shiori.bookmarks|is_array) && count($shiori.bookmarks) > 0}>
                <td class="foot" colspan="5"><input id="del" name="del" type="submit" value="<{"Delete"|shiori_msg}>">
                </td>
            <{else}>
...
<{if $shiori.config.free_input_url == 1}>
    <form name="addbookmark" action="index.php?action=form" method="post">
        <table border="0" class="outer" cellspacing="1" cellpadding="4" summary="table of addition of bookmark"
               style="width:100%;">
            <tr>
                <th colspan="2">
                    <{"Add bookmark from URL"|shiori_msg}>
                </td>
            </tr>
            <tr>
                <td class="head"><{"URL"|shiori_msg}></td>
                <td class="even"><input type="text" name="url" id="url" value="" size="30" style="width:80%;">&nbsp;&nbsp;<input
                            id="add" name="add" type="submit" value="<{"Add"|shiori_msg}>">
                </td>
            </tr>
        </table>
    </form>
