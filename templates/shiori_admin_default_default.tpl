    ...
    <table class="outer" cellspacing="1" style="width:100%;">
        <tr>
            <td class="head" style="text-align:center;">
                <a href="index.php?order=<{if $shiori.order == 1}>-<{/if}>1" style="display:block;color:none;">
                    <{if $shiori.order == 1}><img src="<{$shiori.url}>/images/up.png"
                                                  style="vertical-align:middle;"><{/if}>
                    <{if $shiori.order == -1}><img src="<{$shiori.url}>/images/down.png"
                                                   style="vertical-align:middle;"><{/if}>
                    <{"Page"|shiori_msg}></a>
            </td>
            <td class="head" style="text-align:center;">
                <a href="index.php?order=<{if $shiori.order == 2}>-<{/if}>2" style="display:block;color:none;">
                    <{if $shiori.order == 2}><img src="<{$shiori.url}>/images/up.png"
                                                  style="vertical-align:middle;"><{/if}>
                    <{if $shiori.order == -2}><img src="<{$shiori.url}>/images/down.png"
                                                   style="vertical-align:middle;"><{/if}>
                    <{"Module"|shiori_msg}></a>
            </td>
            <td class="head" style="text-align:center;">
                <a href="index.php?order=<{if $shiori.order == 3}>-<{/if}>3" style="display:block;color:none;">
                    <{if $shiori.order == 3}><img src="<{$shiori.url}>/images/up.png"
                                                  style="vertical-align:middle;"><{/if}>
                    <{if $shiori.order == -3}><img src="<{$shiori.url}>/images/down.png"
                                                   style="vertical-align:middle;"><{/if}>
                    <{"Enrollment"|shiori_msg}></a>
            </td>
            <td class="head" style="text-align:center;">
                <a href="index.php?order=<{if $shiori.order == 4}>-<{/if}>4" style="display:block;color:none;">
                    <{if $shiori.order == 4}><img src="<{$shiori.url}>/images/up.png"
                                                  style="vertical-align:middle;"><{/if}>
                    <{if $shiori.order == -4}><img src="<{$shiori.url}>/images/down.png"
                                                   style="vertical-align:middle;"><{/if}>
                    <{"Clicks"|shiori_msg}></a>
            </td>
        </tr>
        <{foreach from=$shiori.bookmarks item="bookmark"}>
            <tr class="<{cycle values="odd,even"}>">
                ...
                <td><{$bookmark.module_name|default:''}></td>
